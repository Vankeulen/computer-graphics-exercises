...
public class Triple {
   ...
   // render this Triple's data and send to a buffer
   public void sendData( FloatBuffer buffer, Camera camera ) {
      // render this Triple
      Triple r = camera.render( this );

      buffer.put( (float) r.x );
      buffer.put( (float) r.y );
      buffer.put( (float) r.z );
   }
